...
exports.schema = Yup.object().shape({
    ...
    music: Yup.object().shape({
        name: Yup.string().required("اهنگ الزامی است"),
        size: Yup.number().max(300000000, "عکس نباید بیشتر از 30 مگابایت باشد"),
        mimetype: Yup.mixed().oneOf(["music/mp3", "audio/mp3"], "فقط فرمت های jpg , png پشتی بانی میشوند")
    }),
})
